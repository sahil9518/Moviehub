...
import { tvasync } from "../store/actions/tvasync";
import Loading from "./Loading";
import { removetv } from "../store/reducer/TvSlice";
    ...
    <div className="w-full min-h-[100vh] relative">
      ...
      <div className="mx-[50px] relative z-10">
        ...
        <div>
          ...
          {info.recommendations && info.recommendations.length > 0||info.similar&&info.similar.length>0 ?
          <>
          <hr className="mt-10 border-none h-[1.5px] bg-zinc-300" />
          <Horizantalcard
            data={
